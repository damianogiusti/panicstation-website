/* ===== Panic Station — IT/EN/DE/SL string dictionary ===== */
...
var TRANSLATIONS = {
  it: {
    ...
    "band.heading": "BAND",
    "band.p1": "Panic Station è una live band pop rock del Friuli-Venezia Giulia, nata dall'incontro di cinque musicisti con anni di palco alle spalle. Un progetto che unisce l'energia del rock e la freschezza del pop contemporaneo, portato dal vivo tra Friuli e Veneto orientale in locali, sagre ed eventi pubblici con l'intensità di una vera performance.",
    "band.p2": "La setlist spazia dai grandi successi di oggi ai classici che hanno fatto la storia del pop rock: da Dua Lipa, Billie Eilish e Chappell Roan a Green Day, Paramore, Måneskin, The Police e Bon Jovi, passando per hit italiane e internazionali. Un incontro di generi e generazioni che tiene alta l'energia dal primo all'ultimo brano.",
  ...
  en: {
    ...
    "band.heading": "BAND",
    "band.p1": "Panic Station is a pop rock live band from Friuli-Venezia Giulia, bringing together five musicians with years of stage experience. A project that blends the energy of rock with the freshness of contemporary pop, taken live across Friuli and eastern Veneto to clubs, town festivals and public events with the intensity of a true performance.",
    "band.p2": "The setlist spans today's biggest hits and the classics that shaped pop rock — from Dua Lipa, Billie Eilish and Chappell Roan to Green Day, Paramore, Måneskin, The Police and Bon Jovi, alongside Italian and international favourites. A blend of genres and generations that keeps the energy high from the first song to the last.",
    "band.p3": "Behind Panic Station there is real experience: every member comes from years of live concerts and projects, and that maturity shows on stage, in an energetic, tight and engaging performance. A professional band, in its element in clubs, town squares and events of any size.",
  ...
  sl: {
    "meta.description": "Panic Station: pop rock skupina v živo v Furlaniji in Venetu (San Vito al Tagliamento, Portogruaro, Pordenone). Pop uspešnice in rock klasike v živo za zabave, veselice in dogodke.",

    "nav.band": "Skupina",
    "nav.dates": "Nastopi",
    "nav.contact": "Kontakt",
    "nav.download": "Gradivo",

    "downloads.heading": "GRADIVO",
    "downloads.subtitle": "Logotip, plakati, tehnični rider ter avdio/video vsebine skupine.",
    "cards.cta": "Odpri Google Drive",
    "cards.material": "AVDIO / VIDEO <br> GRADIVO",
    "cards.material.desc": "Fotografije, avdio in video posnetki v živo, pripravljeni za poslušanje in ogled.",
    "cards.ads": "PROMOCIJA<br>LOGOTIP IN PLAKATI",
    "cards.ads.desc": "Logotip, plakati in grafike, pripravljeni za tisk za vaš dogodek.",
    "cards.rider": "TEHNIČNI <br> RIDER",
    ...
    "gigs.heading": "Prihajajoči nastopi",
    "contact.heading": "KONTAKT",
